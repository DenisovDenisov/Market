...
// Product.getByName = function (str) {
//   for (var i = InMemoryStorage.products.length - 1; i >= 0; i--) {
//     console.log(InMemoryStorage.products[i]);
//     return InMemoryStorage.products[i];
//   };
// }

// Client.getByName = function (str) {
//   for (var i = InMemoryStorage.clients.length - 1; i >= 0; i--) {
//     console.log(InMemoryStorage.clients[i]);
//     return InMemoryStorage.clients[i];
//   };
// }